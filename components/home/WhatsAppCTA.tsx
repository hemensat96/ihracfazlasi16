    ...
    <section className="section bg-white">
      <div className="container-apple">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-br from-success/10 to-success/5 rounded-apple p-12 md:p-16 text-center"
        >
          {/* WhatsApp Icon */}
          <motion.div
            initial={{ scale: 0 }}
            ...
            className="w-20 h-20 bg-success rounded-full flex items-center justify-center mx-auto mb-8"
          >
          ...
          <p className="text-body-large text-gray-500 max-w-xl mx-auto mb-8">
